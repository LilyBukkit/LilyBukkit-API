...
public class YamlConfiguration extends FileConfiguration {
    ...
    public static YamlConfiguration loadConfiguration(File file) {
        ...
        try {
            ...
            if (ex.getCause() instanceof YAMLException) {
                Bukkit.getServer().getLogger().severe("Config file " + file + " isn't valid! " + ex.getCause());
            } else if ((ex.getCause() == null) || (ex.getCause() instanceof ClassCastException)) {
                Bukkit.getServer().getLogger().severe("Config file " + file + " isn't valid!");
            } else {
                Bukkit.getServer().getLogger().log(Level.SEVERE, "Cannot load " + file + ": " + ex.getCause().getClass(), ex);
            }
        }
    ...
    public static YamlConfiguration loadConfiguration(InputStream stream) {
        ...
        try {
            ...
            Bukkit.getServer().getLogger().log(Level.SEVERE, "Cannot load configuration", ex);
        } catch (InvalidConfigurationException ex) {
            if (ex.getCause() instanceof YAMLException) {
                Bukkit.getServer().getLogger().severe("Config file isn't valid! " + ex.getCause());
            } else if ((ex.getCause() == null) || (ex.getCause() instanceof ClassCastException)) {
                Bukkit.getServer().getLogger().severe("Config file isn't valid!");
            } else {
                Bukkit.getServer().getLogger().log(Level.SEVERE, "Cannot load configuration: " + ex.getCause().getClass(), ex);
            }
        }
